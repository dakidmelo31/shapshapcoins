// ignore_for_file: avoid_print, import_of_legacy_library_into_null_safe, prefer_const_constructors

import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:vibration/vibration.dart';

import 'create_new_pin.dart';


class ChangePin extends StatefulWidget {
  static const routeName = "/changePin";
      ...
      body:Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text("Confirm Old Pin".toUpperCase(), style: TextStyle(color: Colors.grey.withOpacity(0.8)),),
          ),
          Text(_pin),
          Row(
            mainAxisSize: MainAxisSize.max,
