...
class _TransactionHistoryState extends State<TransactionHistory> {
  ...
  int payouts = 0;
  int received = 0;
  bool pendingTransactions = true,
      failedTransactions = true,
      successfulTransactions = true,
      cancelledTransactions = true;
  ...
  Future<void> setSelected(int id) async {
    ...
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => TransactionDetails(id: id)));
  }
                ...
                return snapshot.data!.isEmpty
                    ...
                    : ListView(
                        ...
                        children: snapshot.data!.map((tx) {
                          ...
                          if (true) {
                            payouts += int.parse(tx.amount);
                          }
                          if (true) {
                            received += 0;
                          }

                          var transactionTime = DateFormat()
                              .add_yMMMMEEEEd()
                              .format(DateTime.now());
                          return Column(
                            mainAxisSize: MainAxisSize.min,
                                              ...
                                              errorBuilder:
                                                ...
                                                return ClipOval(
                                                  child: SizedBox(
                                                    ...
                                                    child: Lottie.asset("assets/loadingerror.gif",
                                                        fit: BoxFit.contain
                                                    ),
                                                  ),
                                                );
